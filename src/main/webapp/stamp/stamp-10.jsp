    ...
    <div class="site-item mor">
      <div class="middle">
        <div class="stamp-time row done">
          <div class="left"><span>出勤報告</span></div><div class="right"><%=GetFormatStampDate(stringDate) %><span>済</span></div>
        </div>
      </div>
    </div>
...
%>
    ...
    <div class="site-item mor">
      <div class="middle">
        <div class="stamp-time row done">
          <div class="left"><span>退勤報告</span></div><div class="right"><%=GetFormatStampDate(stringDate) %><span>済</span></div>
        </div>
      </div>
    </div>
...
%>
    ...
    <form name="form1" action="<%= request.getContextPath() %>/AttendList" method="post">
      <button class="white">現場選択に戻る</button>
            ...
            <input type="hidden" value="<%=loginInfo.geoKeido_Value %>" name="geoKeido">
            <input type="hidden" value="<%=stampFlag %>" name="stampFlag">
            <input type="hidden" value="0" name="shiftFlag">
