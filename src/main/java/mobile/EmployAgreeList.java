 ...
 * 雇用契約書一覧を表示
 */
public class EmployAgreeList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EmployAgreeList() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // ログインIDをキーにメッセージを取得
            msgInfo = msg.selectCategory(workInfo);
        ...
        RequestDispatcher dispatch = request.getRequestDispatcher("term/term-2.jsp");
