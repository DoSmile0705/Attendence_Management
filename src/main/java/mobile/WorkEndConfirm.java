...
/**
 * Servlet implementation class WorkEndConfirm
 */
public class WorkEndConfirm extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WorkEndConfirm() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        shiftInfo.bgnStampTime = (String)request.getParameter("bgnStampTime");
		...
		RequestDispatcher dispatch = request.getRequestDispatcher("jsp/endConfirm.jsp");
