...
<body>
  ...
  <main class="p-work">
    <section class="inner">
      ...
      <div class="term-con">
        <div class="btn">
          <form action="<%= request.getContextPath() %>/LaborNoticePageLink" method="post" accept-charset="UTF-8">
          <button>労働通知書を確認する</button>
            <input type="hidden" value="<%=loginInfo.workerIndex %>" name="loginid">
            <input type="hidden" value="<%=loginInfo.id %>" name="id">
            <input type="hidden" value="<%=loginInfo.loginInfo1_Value %>" name="password1">
            <input type="hidden" value="<%=loginInfo.loginInfo2_Value %>" name="password2">
        ...
        <div class="btn">
          <form action="<%= request.getContextPath() %>/EmployAgreeList" method="post" accept-charset="UTF-8">
          <button>雇用契約書を確認する</button>
            <input type="hidden" value="<%=loginInfo.workerIndex %>" name="loginid">
            <input type="hidden" value="<%=loginInfo.id %>" name="id">
            <input type="hidden" value="<%=loginInfo.loginInfo1_Value %>" name="password1">
            <input type="hidden" value="<%=loginInfo.loginInfo2_Value %>" name="password2">
